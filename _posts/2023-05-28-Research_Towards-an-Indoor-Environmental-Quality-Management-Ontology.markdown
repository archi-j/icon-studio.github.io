...
img: Research_IEQ_Ontology.jpg # Add image post (optional)
---
...
<img src="https://drive.google.com/uc?export=view&id=11xeR-lfJd6Xrs0nNTE3iDWYakFYKsquf" class="post_img" style="width:100%;" alt="Process Diagram">

More information can be found on [here](https://indoor-environment-manager--rpi-ontology-engineering.netlify.app/oe2022/indoor-environment-manager/)
